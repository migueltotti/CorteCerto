...
WORKDIR /src
COPY ["src/CorteCerto.Api/CorteCerto.Api.csproj", "src/CorteCerto.Api/"]
COPY ["src/CorteCerto.CrossCutting/CorteCerto.CrossCutting.csproj", "src/CorteCerto.CrossCutting/"]
...
ENTRYPOINT ["dotnet", "CorteCerto.Api.dll"]