...
namespace CorteCerto.Infrastructure.Migrations
{
    ...
    [Migration("20260228135802_Update Address to use Ids of entities instead of navegation properties")]
    partial class UpdateAddresstouseIdsofentitiesinsteadofnavegationproperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CorteCerto.Domain.Entities.Barber", b =>
                {
                    ...
                    b.OwnsMany("CorteCerto.Domain.ValueObjects.BarberAvailability", "Availabilities", b1 =>
                        {
                            b1.Property<Guid>("BarberId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("BarberId", "DayOfWeek");

                            b1.ToTable("BarberAvailabilities", (string)null);
