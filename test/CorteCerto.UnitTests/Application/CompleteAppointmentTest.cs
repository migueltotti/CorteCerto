...
public class CompleteAppointmentTest
{
    private readonly ServiceProvider provider;
    private readonly CompleteAppointmentCommandHandler commandHandler;

    public CompleteAppointmentTest()
    {
    ...
    [Fact]
    public async Task CompleteAppointment_WithIncorrectAppointmentId_ShouldFail()
    {
        // Arrange
    ...
    [Fact]
    public async Task CompleteAppointment_WithIncorrectBarberId_ShouldFail()
    {
        // Arrange
        var command = new CompleteAppointmentCommand(
    ...
    [Fact]
    public async Task CompleteAppointment_WithIncorrectAppointmentStatus_ShouldFail()
    {
        // Arrange
        var command = new CompleteAppointmentCommand(
        ...
        // Assert
        Assert.True(result.IsFailure);
        Assert.Equal(AppointmentErrors.CompleteFailed, result.Error);
    }

    [Fact]
    public async Task CompleteAppointment_WithValidArguments_ShouldCompleteAppointmentWithSuccess()
    {
        // Arrange
        var command = new CompleteAppointmentCommand(
            Guid.Parse("ff410b56-fa74-409a-8c8e-f0f94885f1d5"),
